...
/usr/local/i386elfgcc/bin/i386-elf-gcc -I lib/ -I kernel/  -c -o build/timer.o device/timer.c
...
/usr/local/i386elfgcc/bin/i386-elf-gcc -I lib/ -I device/ -I kernel/ -c -fno-builtin -o build/init.o kernel/init.c
